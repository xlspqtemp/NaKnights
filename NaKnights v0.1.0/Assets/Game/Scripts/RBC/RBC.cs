...
public class RBC : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        pointA = GameObject.FindGameObjectWithTag("1.1").transform.position;
        pointB = GameObject.FindGameObjectWithTag("1.2").transform.position;
        pointC = GameObject.FindGameObjectWithTag("1.3").transform.position;
